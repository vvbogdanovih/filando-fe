...
export const CatalogProductCard = ({ item, href }: CatalogProductCardProps) => {
	...
	return (
		<div className='card-hover bg-card border-border/50 flex flex-col overflow-hidden rounded-xl border shadow-lg shadow-black/10'>
			<Link href={href} className='block flex-1'>
				...
				<div className='space-y-1 p-3'>
					<p className='line-clamp-2 text-sm leading-tight font-medium'>{item.name}</p>
